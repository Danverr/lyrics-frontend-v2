<script lang="ts">
	...
	import { getPrevText } from '$lib/components/novel-editor/editor';
	...
	import ImageResizer from './extensions/image/ImageResizer.svelte';
	...
	import EditorBubbleMenu from '$lib/components/novel-editor/ui/editor/extensions/bubble-menu/index.svelte';
